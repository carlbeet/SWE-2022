...
import { filterUndefined, memoizedGet as get, merge, runIfFn } from "@chakra-ui/utils";
...
export function useProps(themeKey, props, isMultiPart) {
  ...
  var mergedProps = merge({}, propsWithDefault, {
    theme,
    colorMode
  });
  var memoizedStyles = useMemo(() => {
    if (styleConfig) {
      ...
      var styles = merge(baseStyles, sizes, variants);

      if (styleConfig.parts) {
        for (var part of styleConfig.parts) {
          var _styles$part;

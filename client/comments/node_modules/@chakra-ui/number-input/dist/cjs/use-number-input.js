...
function useNumberInput(props) {
  ...
  var getInputProps = (0, _react.useCallback)(function (props, ref) {
    ...
    return _extends({}, props, {
      ...
      onWheel: (0, _utils.callAllHandlers)(props.onWheel, onWheel)
    });
  }, [inputMode, pattern, ariaValueText, counter.isOutOfRange, counter.value, counter.valueAsNumber, id, isDisabled, isInvalid, isReadOnly, max, min, onBlur, onChange, onKeyDown, onWheel, setFocused.on]);
  return {
    value: counter.value,

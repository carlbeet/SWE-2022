...
var Checkbox = /*#__PURE__*/(0, _system.forwardRef)(function Checkbox(props, ref) {
  ...
  var _ownProps$spacing = ownProps.spacing,
      ...
      Icon = _ownProps$icon === void 0 ? /*#__PURE__*/React.createElement(_checkbox.CheckboxIcon, null) : _ownProps$icon,
      rest = _objectWithoutPropertiesLoose(ownProps, ["spacing", "className", "children", "iconColor", "iconSize", "icon"]);
  ...
  var icon = /*#__PURE__*/React.cloneElement(Icon, {
    __css: iconStyles,
  ...
  }, checkboxProps), icon), children && /*#__PURE__*/React.createElement(_system.chakra.div, _extends({

...
export function useCounter(props) {
  ...
  var increment = useCallback(function (step) {
    ...
    if (value === "") {
      var _props$min$toString, _props$min;

      /**
       * If `min` is set, native input, starts at the `min`.
       * Else, it starts at `step`
       */
      next = (_props$min$toString = (_props$min = props.min) == null ? void 0 : _props$min.toString()) != null ? _props$min$toString : parse("0") + step;
    } else {
  ...
  var decrement = useCallback(function (step) {
    ...
    if (value === "") {
      var _props$min$toString2, _props$min2;

      next = (_props$min$toString2 = (_props$min2 = props.min) == null ? void 0 : _props$min2.toString()) != null ? _props$min$toString2 : parse("0") - step;
    } else {
      next = parse(value) - step;
    }

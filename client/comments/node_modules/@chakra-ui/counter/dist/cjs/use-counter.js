...
function useCounter(props) {
  ...
  var increment = (0, _react.useCallback)(function (step) {
    ...
    if (value === "") {
      var _props$min$toString, _props$min2;

      /**
       * If `min` is set, native input, starts at the `min`.
       * Else, it starts at `step`
       */
      next = (_props$min$toString = (_props$min2 = props.min) == null ? void 0 : _props$min2.toString()) != null ? _props$min$toString : parse("0") + step;
    } else {
  ...
  var decrement = (0, _react.useCallback)(function (step) {
    ...
    if (value === "") {
      var _props$min$toString2, _props$min3;

      next = (_props$min$toString2 = (_props$min3 = props.min) == null ? void 0 : _props$min3.toString()) != null ? _props$min$toString2 : parse("0") - step;
    } else {
      next = parse(value) - step;
    }
